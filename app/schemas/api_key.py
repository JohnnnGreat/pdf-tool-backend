...
TIER_LIMITS: dict[str, dict] = {
    "free":       {"monthly": 100,    "per_minute": 10,  "price_usd": 0},
    "starter":    {"monthly": 1_000,  "per_minute": 30,  "price_usd": 29},
    "pro":        {"monthly": 10_000, "per_minute": 60,  "price_usd": 99},
    "enterprise": {"monthly": None,   "per_minute": 120, "price_usd": 299},
}
...
class APIKeyUpgradeTier(BaseModel):
    tier: str = Field(description="Target tier: free | starter | pro | enterprise")
...
class APIKeyResponse(BaseModel):
    id: int
    name: str
    key_prefix: str          # e.g. "df_Abc12345" — safe to show always
    tier: str
    is_active: bool
